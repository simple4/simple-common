...
public class Document extends Element {
	 ...
	 */
	public String title() {
		// title is a preserve whitespace tag (for document output), but
		// normalised here
		final Element titleEl = getElementsByTag("title").first();
	...
	/**
	 * Create a new Element, with this document's base uri. Does not make the new
