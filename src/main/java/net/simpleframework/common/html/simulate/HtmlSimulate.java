package net.simpleframework.common.html.simulate;
...
public abstract class HtmlSimulate {
	...
	static {
		...
		try {
			eval(IoUtils.getStringFromInputStream(ClassUtils.getResourceAsStream(HtmlSimulate.class,
					"env.rhino.1.2.js")), "env.rhino.1.2");
	...
	public static void main(final String[] args) {
		try {
			...
			System.out.println(htmlToHtml(IoUtils.getStringFromInputStream(ClassUtils
