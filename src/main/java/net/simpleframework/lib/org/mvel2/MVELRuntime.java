...
import static net.simpleframework.lib.org.mvel2.Operator.NOOP;
...
import net.simpleframework.lib.org.mvel2.debug.Debugger;
import net.simpleframework.lib.org.mvel2.debug.DebuggerContext;
...
public class MVELRuntime {
	 ...
	 * @see org.mvel2.MVEL
	 */
	public static Object execute(boolean debugger, final CompiledExpression expression,
			final Object ctx, final VariableResolverFactory variableFactory) {
		...
		try {
			do {
				...
				try {
					...
					throw new CompileException("failed to compileShared sub expression", new char[0], 0,
							e);
				}
