...
import static net.simpleframework.lib.org.mvel2.Operator.ASSIGN;
import static net.simpleframework.lib.org.mvel2.Operator.ASSIGN_ADD;
import static net.simpleframework.lib.org.mvel2.Operator.ASSIGN_DIV;
import static net.simpleframework.lib.org.mvel2.Operator.ASSIGN_MOD;
import static net.simpleframework.lib.org.mvel2.Operator.ASSIGN_SUB;
import static net.simpleframework.lib.org.mvel2.Operator.BW_AND;
import static net.simpleframework.lib.org.mvel2.Operator.BW_OR;
import static net.simpleframework.lib.org.mvel2.Operator.BW_SHIFT_LEFT;
import static net.simpleframework.lib.org.mvel2.Operator.BW_SHIFT_RIGHT;
import static net.simpleframework.lib.org.mvel2.Operator.BW_USHIFT_LEFT;
import static net.simpleframework.lib.org.mvel2.Operator.BW_USHIFT_RIGHT;
import static net.simpleframework.lib.org.mvel2.Operator.BW_XOR;
import static net.simpleframework.lib.org.mvel2.Operator.CHOR;
import static net.simpleframework.lib.org.mvel2.Operator.CONTAINS;
import static net.simpleframework.lib.org.mvel2.Operator.CONVERTABLE_TO;
import static net.simpleframework.lib.org.mvel2.Operator.DEC;
import static net.simpleframework.lib.org.mvel2.Operator.DIV;
import static net.simpleframework.lib.org.mvel2.Operator.DO;
import static net.simpleframework.lib.org.mvel2.Operator.ELSE;
import static net.simpleframework.lib.org.mvel2.Operator.END_OF_STMT;
import static net.simpleframework.lib.org.mvel2.Operator.EQUAL;
import static net.simpleframework.lib.org.mvel2.Operator.FOR;
import static net.simpleframework.lib.org.mvel2.Operator.FOREACH;
import static net.simpleframework.lib.org.mvel2.Operator.FUNCTION;
...
import static net.simpleframework.lib.org.mvel2.Operator.IF;
import static net.simpleframework.lib.org.mvel2.Operator.IMPORT;
import static net.simpleframework.lib.org.mvel2.Operator.IMPORT_STATIC;
import static net.simpleframework.lib.org.mvel2.Operator.INC;
import static net.simpleframework.lib.org.mvel2.Operator.INSTANCEOF;
import static net.simpleframework.lib.org.mvel2.Operator.ISDEF;
...
import static net.simpleframework.lib.org.mvel2.Operator.MOD;
...
import static net.simpleframework.lib.org.mvel2.Operator.NEW;
import static net.simpleframework.lib.org.mvel2.Operator.OR;
import static net.simpleframework.lib.org.mvel2.Operator.POWER;
import static net.simpleframework.lib.org.mvel2.Operator.PROJECTION;
import static net.simpleframework.lib.org.mvel2.Operator.PROTO;
...
import static net.simpleframework.lib.org.mvel2.Operator.RETURN;
...
import static net.simpleframework.lib.org.mvel2.Operator.STACKLANG;
import static net.simpleframework.lib.org.mvel2.Operator.STR_APPEND;
import static net.simpleframework.lib.org.mvel2.Operator.SUB;
import static net.simpleframework.lib.org.mvel2.Operator.SWITCH;
...
import static net.simpleframework.lib.org.mvel2.Operator.UNTIL;
import static net.simpleframework.lib.org.mvel2.Operator.UNTYPED_VAR;
import static net.simpleframework.lib.org.mvel2.Operator.WHILE;
import static net.simpleframework.lib.org.mvel2.Operator.WITH;
...
import static net.simpleframework.lib.org.mvel2.util.ParseTools.handleStringEscapes;
import static net.simpleframework.lib.org.mvel2.util.ParseTools.isArrayType;
import static net.simpleframework.lib.org.mvel2.util.ParseTools.isDigit;
import static net.simpleframework.lib.org.mvel2.util.ParseTools.isIdentifierPart;
import static net.simpleframework.lib.org.mvel2.util.ParseTools.isNotValidNameorLabel;
import static net.simpleframework.lib.org.mvel2.util.ParseTools.isPropertyOnly;
import static net.simpleframework.lib.org.mvel2.util.ParseTools.isReservedWord;
...
import net.simpleframework.lib.org.mvel2.ast.AssertNode;
import net.simpleframework.lib.org.mvel2.ast.AssignmentNode;
import net.simpleframework.lib.org.mvel2.ast.BooleanNode;
import net.simpleframework.lib.org.mvel2.ast.DeclProtoVarNode;
import net.simpleframework.lib.org.mvel2.ast.DeclTypedVarNode;
import net.simpleframework.lib.org.mvel2.ast.DeepAssignmentNode;
import net.simpleframework.lib.org.mvel2.ast.DoNode;
import net.simpleframework.lib.org.mvel2.ast.DoUntilNode;
import net.simpleframework.lib.org.mvel2.ast.EndOfStatement;
import net.simpleframework.lib.org.mvel2.ast.Fold;
import net.simpleframework.lib.org.mvel2.ast.ForEachNode;
import net.simpleframework.lib.org.mvel2.ast.ForNode;
import net.simpleframework.lib.org.mvel2.ast.Function;
import net.simpleframework.lib.org.mvel2.ast.IfNode;
import net.simpleframework.lib.org.mvel2.ast.ImportNode;
import net.simpleframework.lib.org.mvel2.ast.IndexedAssignmentNode;
import net.simpleframework.lib.org.mvel2.ast.IndexedDeclTypedVarNode;
import net.simpleframework.lib.org.mvel2.ast.IndexedOperativeAssign;
import net.simpleframework.lib.org.mvel2.ast.IndexedPostFixDecNode;
import net.simpleframework.lib.org.mvel2.ast.IndexedPostFixIncNode;
import net.simpleframework.lib.org.mvel2.ast.IndexedPreFixDecNode;
import net.simpleframework.lib.org.mvel2.ast.IndexedPreFixIncNode;
import net.simpleframework.lib.org.mvel2.ast.InlineCollectionNode;
import net.simpleframework.lib.org.mvel2.ast.InterceptorWrapper;
import net.simpleframework.lib.org.mvel2.ast.Invert;
import net.simpleframework.lib.org.mvel2.ast.IsDef;
import net.simpleframework.lib.org.mvel2.ast.LineLabel;
import net.simpleframework.lib.org.mvel2.ast.LiteralDeepPropertyNode;
import net.simpleframework.lib.org.mvel2.ast.LiteralNode;
import net.simpleframework.lib.org.mvel2.ast.Negation;
import net.simpleframework.lib.org.mvel2.ast.NewObjectNode;
import net.simpleframework.lib.org.mvel2.ast.NewPrototypeNode;
import net.simpleframework.lib.org.mvel2.ast.OperativeAssign;
import net.simpleframework.lib.org.mvel2.ast.OperatorNode;
import net.simpleframework.lib.org.mvel2.ast.PostFixDecNode;
import net.simpleframework.lib.org.mvel2.ast.PostFixIncNode;
import net.simpleframework.lib.org.mvel2.ast.PreFixDecNode;
import net.simpleframework.lib.org.mvel2.ast.PreFixIncNode;
import net.simpleframework.lib.org.mvel2.ast.Proto;
import net.simpleframework.lib.org.mvel2.ast.ProtoVarNode;
import net.simpleframework.lib.org.mvel2.ast.RedundantCodeException;
import net.simpleframework.lib.org.mvel2.ast.RegExMatch;
import net.simpleframework.lib.org.mvel2.ast.ReturnNode;
import net.simpleframework.lib.org.mvel2.ast.Sign;
import net.simpleframework.lib.org.mvel2.ast.Stacklang;
import net.simpleframework.lib.org.mvel2.ast.StaticImportNode;
import net.simpleframework.lib.org.mvel2.ast.Substatement;
import net.simpleframework.lib.org.mvel2.ast.ThisWithNode;
import net.simpleframework.lib.org.mvel2.ast.TypeCast;
import net.simpleframework.lib.org.mvel2.ast.TypeDescriptor;
import net.simpleframework.lib.org.mvel2.ast.TypedVarNode;
import net.simpleframework.lib.org.mvel2.ast.Union;
import net.simpleframework.lib.org.mvel2.ast.UntilNode;
import net.simpleframework.lib.org.mvel2.ast.WhileNode;
...
public class AbstractParser implements Parser, Serializable {
	...
	protected ASTNode nextToken() {
				...
				if (!lastWasLineLabel) {
					if (pCtx.getSourceFile() == null) {
						throw new CompileException(
								"unable to produce debugging symbols: source name must be provided.", expr,
								st);
					}
					...
					final int line = pCtx.getLineFor(pCtx.getSourceFile(), cursor);

					if (!pCtx.isVisitedLine(pCtx.getSourceFile(), pCtx.setLineCount(line))
							&& !pCtx.isBlockSymbols()) {
				...
				if (capture) {
					...
					if (OPERATORS.containsKey(t = new String(expr, st, cursor - st))) {
						...
						case NEW:
							...
							/**
							 * If it's not a dimentioned array, continue capturing if
							 * necessary.
							 */
							...
							if (cursor != end && expr[cursor] == '{') {
								...
								cursor = balancedCaptureWithLineAccounting(expr, st, end, expr[cursor],
										pCtx) + 1;
								if (tokenContinues()) {
									...
									return lastNode = new InlineCollectionNode(expr, st, cursor - st,
											fields, egressType, pCtx);
								}
						...
						case IMPORT:
							...
							if (importNode.isPackageImport()) {
								...
								pCtx.addImport(importNode.getImportClass().getSimpleName(),
										importNode.getImportClass());
							}
						...
						case UNTYPED_VAR:
							...
							while (true) {
								...
								if (cursor != end && expr[cursor] == '=') {
									if (end == (cursor = st)) {
										throw new CompileException("illegal use of reserved word: var", expr,
												st);
									}
									...
									if (pCtx != null && (idx = pCtx.variableIndexOf(name)) != -1) {
										splitAccumulator.add(lastNode = new IndexedDeclTypedVarNode(idx, st,
												end - st, Object.class, pCtx));
									} else {
										splitAccumulator.add(lastNode = new DeclTypedVarNode(name, expr, st,
												end - st, Object.class, fields, pCtx));
									}
								}
					...
					CaptureLoop: while (cursor != end) {
						...
						case '+':
							...
							case '=':
								...
								if (union) {
									return lastNode = new DeepAssignmentNode(expr, st = trimRight(st),
											trimLeft(cursor) - st, fields, ADD, name, pCtx);
								} else if (pCtx != null && (idx = pCtx.variableIndexOf(name)) != -1) {
									return lastNode = new IndexedAssignmentNode(expr, st, cursor - st,
											fields, ADD, name, idx, pCtx);
								} else {
									return lastNode = new OperativeAssign(name, expr, st = trimRight(st),
											trimLeft(cursor) - st, ADD, fields, pCtx);
								}
							}

							if (isDigit(lookAhead()) && cursor > 1
									&& (expr[cursor - 1] == 'E' || expr[cursor - 1] == 'e')
						...
						case '-':
							...
							case '=':
								...
								if (union) {
									...
									return lastNode = new IndexedOperativeAssign(expr, st, cursor - st, SUB,
											idx, fields, pCtx);
								} else {
									return lastNode = new OperativeAssign(name, expr, st, cursor - st, SUB,
											fields, pCtx);
								}
							}
						...
						case '~':
							if (lookAhead() == '=') {
								...
								tmpStart = st;
								final int tmpOffset = cursor - st;
								st = cursor += 2;

								captureToEOT();

								return lastNode = new RegExMatch(expr, tmpStart, tmpOffset, fields, st,
										cursor - st, pCtx);
							}
							break CaptureLoop;
						...
						case '=':
							if (lookAhead() == '+') {
								...
								if (!isNextIdentifierOrLiteral()) {
									throw new CompileException("unexpected symbol '" + expr[cursor] + "'",
											expr, st);
								}
								...
								if (pCtx != null && (idx = pCtx.variableIndexOf(name)) != -1) {
									return lastNode = new IndexedOperativeAssign(expr, st, cursor - st, ADD,
											idx, fields, pCtx);
								} else {
									return lastNode = new OperativeAssign(name, expr, st, cursor - st, ADD,
											fields, pCtx);
								}
							} else if (lookAhead() == '-') {
								name = new String(expr, st, trimLeft(cursor) - st);
							...
							if (greedy && lookAhead() != '=') {
								...
								if (union) {
									...
									return procTypedNode(false);
										...
										&& ((idx = pCtx.variableIndexOf(t)) != -1 && (pCtx
												.isIndexAllocation()))) {
									captureToEOS();

									final IndexedAssignmentNode ian = new IndexedAssignmentNode(expr,
											st = trimRight(st), trimLeft(cursor) - st, ASTNode.ASSIGN, idx,
											pCtx);
									...
									return lastNode = new AssignmentNode(expr, st, cursor - st, fields
											| ASTNode.ASSIGN, pCtx);
								}
							}
							break CaptureLoop;
					...
					case '.': {
						...
						return lastNode = new ThisWithNode(
								expr,
								st,
								cursor - st - 1,
								cursor + 1,
								(cursor = balancedCaptureWithLineAccounting(expr, cursor, end, '{', pCtx) + 1) - 3,
								fields, pCtx);
					}
					...
					case '@': {
						...
						if (pCtx == null
								|| (pCtx.getInterceptors() == null || !pCtx.getInterceptors().containsKey(
										name = new String(expr, st, cursor - st)))) {
							throw new CompileException("reference to undefined interceptor: "
									+ new String(expr, st, cursor - st), expr, st);
						}

						return lastNode = new InterceptorWrapper(pCtx.getInterceptors().get(name),
								nextToken(), pCtx);
					}
					...
					case '-':
						...
						} else if ((cursor - 1) != start || (!isDigit(expr[cursor - 1]))
								&& isDigit(lookAhead())) {
							cursor++;
							break;
						} else {
					...
					case '(': {
						...
						for (brace = 1; cursor != end && brace != 0; cursor++) {
							...
							case '"':
								...
								break;
							case 'i':
								if (brace == 1 && isWhitespace(lookBehind()) && lookAhead() == 'n'
										&& isWhitespace(lookAhead(2))) {

									for (final int level = brace; cursor != end; cursor++) {
										switch (expr[cursor]) {
										case '(':
											brace++;
											break;
										case ')':
											if (--brace < level) {
												...
												if (tokenContinues()) {
													...
													captureToEOT();
													return lastNode = new Union(expr, st = trimRight(st), cursor
															- st, fields, lastNode, pCtx);
												} else {
													return lastNode = new Fold(expr, trimRight(st + 1), cursor
															- st - 2, fields, pCtx);
												}
											}
											break;
									...
									throw new CompileException(
											"unterminated projection; closing parathesis required", expr, st);
								}
								break;
						...
						if (brace != 0) {
							throw new CompileException(
									"unbalanced braces in expression: (" + brace + "):", expr, st);
						}

						tmpStart = -1;
						if (singleToken) {
							int _st;
							final TypeDescriptor tDescr = new TypeDescriptor(expr,
									_st = trimRight(st + 1), trimLeft(cursor - 1) - _st, fields);
							...
							try {
								if (tDescr.isClass() && (cls = getClassReference(pCtx, tDescr)) != null) {
									...
									for (int i = cursor; i < expr.length; i++) {
										...
										isCast = isIdentifierPart(expr[i]) || expr[i] == '\''
												|| expr[i] == '"' || expr[i] == '(';
										break;
									}
									...
									if (isCast) {
										...
										return lastNode = new TypeCast(expr, st, cursor - st, cls, fields,
												pCtx);
									}
								}
							} catch (final ClassNotFoundException e) {
						...
						if (tmpStart != -1) {
							return handleUnion(handleSubstatement(new Substatement(expr, tmpStart, cursor
									- tmpStart, fields, pCtx)));
						} else {
							return handleUnion(handleSubstatement(new Substatement(expr,
									st = trimRight(st + 1), trimLeft(cursor - 1) - st, fields, pCtx)));
						}
					}
					...
					case '"':
						lastNode = new LiteralNode(
								handleStringEscapes(subset(expr, st + 1,
										(cursor = captureStringLiteral(expr[cursor], expr, cursor, end)) - st
												- 1)), String.class, pCtx);
		...
		} catch (final RedundantCodeException e) {
			return nextToken();
		...
		if (isPropertyOnly(expr, st, end)) {
			if (pCtx != null && pCtx.hasImports()) {
				...
				if ((find = findFirst('.', st, end - st, expr)) != -1) {
					final String iStr = new String(expr, st, find - st);
					if (pCtx.hasImport(iStr)) {
						lastWasIdentifier = true;
						return lastNode = new LiteralDeepPropertyNode(expr, find + 1, end - find - 1,
								fields, pCtx.getImport(iStr), pCtx);
					}
				} else {
		...
		if (pCtx != null && pCtx.hasImports() && isArrayType(expr, st, end)) {
			if (pCtx.hasImport(new String(expr, st, cursor - st - 2))) {
				...
				try {
					...
					throw new CompileException("could not resolve class: "
							+ typeDescriptor.getClassName(), expr, st);
				}
			}
		}
	...
	private ASTNode procTypedNode(final boolean decl) {
		while (true) {
			if (lastNode.getLiteralValue() instanceof String) {
				final char[] tmp = ((String) lastNode.getLiteralValue()).toCharArray();
				final TypeDescriptor tDescr = new TypeDescriptor(tmp, 0, tmp.length, 0);
			...
			if (lastNode.isLiteral() && lastNode.getLiteralValue() instanceof Class) {
				...
				if (decl) {
					splitAccumulator.add(new DeclTypedVarNode(new String(expr, st, cursor - st), expr,
							st, cursor - st, (Class) lastNode.getLiteralValue(), fields | ASTNode.ASSIGN,
							pCtx));
				} else {
					captureToEOS();
					splitAccumulator.add(new TypedVarNode(expr, st, cursor - st - 1, fields
							| ASTNode.ASSIGN, (Class) lastNode.getLiteralValue(), pCtx));
				}
				...
				if (decl) {
					...
					splitAccumulator.add(new ProtoVarNode(expr, st, cursor - st,
							fields | ASTNode.ASSIGN, (Proto) lastNode, pCtx));
				}
			}

			// this redundant looking code is needed to work with the interpreter
			// and MVELSH properly.
			else if ((fields & ASTNode.COMPILE_IMMEDIATE) == 0) {
				if (stk.peek() instanceof Class) {
					captureToEOS();
					if (decl) {
						splitAccumulator.add(new DeclTypedVarNode(new String(expr, st, cursor - st),
								expr, st, cursor - st, (Class) stk.pop(), fields | ASTNode.ASSIGN, pCtx));
					} else {
						splitAccumulator.add(new TypedVarNode(expr, st, cursor - st, fields
								| ASTNode.ASSIGN, (Class) stk.pop(), pCtx));
					}
					...
					if (decl) {
						...
						splitAccumulator.add(new ProtoVarNode(expr, st, cursor - st, fields
								| ASTNode.ASSIGN, (Proto) stk.pop(), pCtx));
					}
				} else {
					throw new CompileException("unknown class or illegal statement: "
							+ lastNode.getLiteralValue(), expr, cursor);
				}
			} else {
				throw new CompileException("unknown class or illegal statement: "
						+ lastNode.getLiteralValue(), expr, cursor);
	...
	private ASTNode createBlockToken(final int condStart, final int condEnd, final int blockStart,
			final int blockEnd, final int type) {
		lastWasIdentifier = false;
		cursor++;
		...
		final int condOffset = condEnd - condStart;
		...
		case ASTNode.BLOCK_FOR:
			for (int i = condStart; i < condEnd; i++) {
				if (expr[i] == ';') {
					return new ForNode(expr, condStart, condOffset, blockStart, blockOffset, fields,
							pCtx);
				} else if (expr[i] == ':') {
					break;
				}
	...
	private ASTNode _captureBlock(final ASTNode node, final char[] expr, final boolean cond,
			final int type) {
		skipWhitespace();
		int startCond = 0;
		int endCond = 0;
		...
		/**
		 * Functions are a special case we handle differently from the rest of
		 * block parsing
		 */
		switch (type) {
		...
		case FUNCTION: {
			...
			if (isReservedWord(name = createStringTrimmed(expr, st, cursor - st))
				...
				throw new CompileException("illegal function name or use of reserved word", expr,
						cursor);
			}
		...
		case PROTO: {
			...
			if (isReservedWord(name = createStringTrimmed(expr, st, cursor - st))
					|| isNotValidNameorLabel(name)) {
				throw new CompileException("illegal prototype name or use of reserved word", expr,
						cursor);
			}
		...
		default:
			if (cond) {
				if (expr[cursor] != '(') {
					throw new CompileException("expected '(' but encountered: " + expr[cursor], expr,
							cursor);
				}
		...
		if (type == ASTNode.BLOCK_IF) {
			...
			if (node != null) {
				if (!cond) {
					return ifNode.setElseBlock(expr, st = trimRight(blockStart + 1), trimLeft(blockEnd)
							- st, pCtx);
				} else {
					return ifNode.setElseIf((IfNode) createBlockToken(startCond, endCond,
							trimRight(blockStart + 1), trimLeft(blockEnd), type));
				}
			} else {
			...
			if ("while".equals(name = new String(expr, st, cursor - st))) {
				...
				endCond = cursor = balancedCaptureWithLineAccounting(expr, cursor, end, '(', pCtx);
				return createBlockToken(startCond, endCond, trimRight(blockStart + 1),
						trimLeft(blockEnd), ASTNode.BLOCK_DO_UNTIL);
			} else {
				throw new CompileException("expected 'while' or 'until' but encountered: " + name,
						expr, cursor);
			}
		}
	...
	protected boolean tokenContinues() {
		if (cursor == end) {
			return false;
		} else if (expr[cursor] == '.' || expr[cursor] == '[') {
			return true;
		} else if (isWhitespace(expr[cursor])) {
			final int markCurrent = cursor;
			skipWhitespace();
			if (cursor != end && (expr[cursor] == '.' || expr[cursor] == '[')) {
				return true;
			}
			cursor = markCurrent;
		}
	...
	/**
	 * The parser should find a statement ending condition when this is called,
	 * otherwise everything should blow up.
	 */
	...
	/**
	 * From the current cursor position, capture to the end of statement, or the
	...
	protected void captureIdentifier() {
		...
		if (cursor == end) {
			throw new CompileException("unexpected end of statement: EOF", expr, cursor);
		}
		while (cursor != end) {
			switch (expr[cursor]) {
			case ';':
			...
			default: {
				if (!isIdentifierPart(expr[cursor])) {
					...
					throw new CompileException("unexpected symbol (was expecting an identifier): "
	...
	protected boolean lastNonWhite(final char c) {
		int i = cursor - 1;
	 ...
	 * to the first non-whitespace character, but account for carraige returns in
	...
	/**
	 * From the current cursor position, capture to the end of the next token
	 * junction.
	 */
	...
	/**
	 * From the current cursor position, trim backward over any whitespace to the
	...
	protected char lookToLast() {
		...
		int temp = cursor;
		for (;;) {
			if (temp == start || !isWhitespace(expr[--temp])) {
				break;
			}
		}
		return expr[temp];
	...
	public void expectNextChar_IW(final char c) {
		...
		if (expr[cursor] != c) {
			throw new CompileException("unexpected character ('" + expr[cursor]
					+ "'); was expecting: " + c, expr, st);
		}
	}
	...
	protected void addFatalError(final String message) {
		pCtx.addError(new ErrorDetail(expr, st, true, message));
	}

	protected void addFatalError(final String message, final int start) {
	...
	public static void setLanguageLevel(final int level) {
		OPERATORS.clear();
	...
	protected int arithmeticFunctionReduction(int operator) {
		...
		if ((tk = nextToken()) != null) {
			if (isArithmeticOperator(operator2 = tk.getOperator())
				...
				while (true) {
					...
					if ((tk = nextToken()) != null && (operator2 = tk.getOperator()) != -1
						...
						// if we have back to back operations on the stack, we don't
						// xswap
						...
						if (PTABLE[operator2] == PTABLE[operator]) {
							...
							/**
							 * This operator is of the same level precedence. push to
							 * the RHS.
							 */
							...
							/**
							 * The operator doesn't have higher precedence. Therfore
							 * reduce the LHS.
							 */
							while (dStack.size() > 1) {
								dreduce();
	...
	protected void reduce() {
		...
		try {
			...
			case CONVERTABLE_TO:
				stk.push(net.simpleframework.lib.org.mvel2.DataConversion.canConvert(stk.peek2()
						.getClass(), (Class) stk.pop2()));
				break;
			...
			case SOUNDEX:
				stk.push(soundex(java.lang.String.valueOf(stk.pop())).equals(
						soundex(java.lang.String.valueOf(stk.pop()))));
				break;

			case SIMILARITY:
				stk.push(similarity(java.lang.String.valueOf(stk.pop()),
						java.lang.String.valueOf(stk.pop())));
				break;
	...
	private void reduceNumeric(final int operator) {
		final Object op1 = stk.peek2();
		final Object op2 = stk.pop2();
	...
	private void reduce(final int op1, final int operator, final int op2) {
		switch (operator) {
		case BW_AND:
			stk.push(op1 & op2);
			break;
	...
	private void reduce(final int op1, final int operator, final long op2) {
		switch (operator) {
		case BW_AND:
			stk.push(op1 & op2);
			break;
	...
	private void reduce(final long op1, final int operator, final int op2) {
		switch (operator) {
		case BW_AND:
			stk.push(op1 & op2);
			break;
	...
	private void reduce(final long op1, final int operator, final long op2) {
		switch (operator) {
		case BW_AND:
			stk.push(op1 & op2);
			break;
