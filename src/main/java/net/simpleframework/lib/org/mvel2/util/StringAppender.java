...
public class StringAppender implements CharSequence {
	...
	public void getChars(final int start, final int count, final char[] target, final int offset) {
		int delta = offset;
