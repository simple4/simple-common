...
public interface PropertyHandler {
	 ...
	 *           - the root variable factory provided by the runtime.
	 ...
	 *           - the root variable factory provided by the runtime.
	 * @param value
	 *           - the value to be set to the resolved property
	 * @return - the resultant value of the property (should normally be the same
	 *         as the value passed)
	 */
