...
import static net.simpleframework.lib.org.mvel2.util.ParseTools.loadFromFile;
import static net.simpleframework.lib.org.mvel2.util.ParseTools.optimizeTree;
...
import net.simpleframework.lib.org.mvel2.integration.impl.CachedMapVariableResolverFactory;
import net.simpleframework.lib.org.mvel2.integration.impl.CachingMapVariableResolverFactory;
...
public class MVEL {
	 ...
	 * @see #eval(String, org.mvel2.integration.VariableResolverFactory)
	 */
	public static Object eval(final String expression, final Map<String, Object> vars) {
		final CachingMapVariableResolverFactory factory = new CachingMapVariableResolverFactory(vars);
		try {
	...
	/**
	 * Evaluates an expression and, if necessary, coerces the resultant value to
	 * the specified type. Example:
	 * 
	 * <pre>
	 * <code>
	 ...
	 */
	public static <T> T eval(final String expression, final Object ctx, final Class<T> toType) {
	 ...
	 * @see #eval(String, Class)
	 */
	public static <T> T eval(final String expression, final VariableResolverFactory vars,
	 ...
	 * @see #eval(String, org.mvel2.integration.VariableResolverFactory)
	 */
	public static <T> T eval(final String expression, final Map<String, Object> vars,
			final Class<T> toType) {
		final CachingMapVariableResolverFactory factory = new CachingMapVariableResolverFactory(vars);
		try {
	 ...
	 * @see #eval(String, Class)
	 */
	public static <T> T eval(final String expression, final Object ctx,
			final VariableResolverFactory vars, final Class<T> toType) {
	 ...
	 */
	public static <T> T eval(final String expression, final Object ctx,
			final Map<String, Object> vars, final Class<T> toType) {
		final CachingMapVariableResolverFactory factory = new CachingMapVariableResolverFactory(vars);
		try {
	 ...
	 */
	public static String evalToString(final String expression, final Object ctx) {
	 ...
	 * @see #eval(String, VariableResolverFactory)
	 */
	public static String evalToString(final String expression, final VariableResolverFactory vars) {
	 ...
	 * @see #eval(String, Map)
	 */
	public static String evalToString(final String expression, final Map vars) {
		return valueOf(eval(expression, vars));
	}
	 ...
	 * @see #eval(String, Map)
	 */
	public static String evalToString(final String expression, final Object ctx, final Map vars) {
		return valueOf(eval(expression, ctx, vars));
	}
	 ...
	 * @see #eval(String)
	 */
	public static Object eval(final char[] expression) {
		return new MVELInterpretedRuntime(expression, new ImmutableDefaultFactory()).parse();
	}
	 ...
	 * @see #eval(String, Object)
	 */
	public static Object eval(final char[] expression, final Object ctx) {
		return new MVELInterpretedRuntime(expression, ctx).parse();
	}

	public static <T> T eval(final char[] expression, final Class<T> type) {
	...
	public static Object eval(final char[] expression, final int start, final int offset,
			final Object ctx, final VariableResolverFactory vars) {
		return new MVELInterpretedRuntime(expression, start, offset, ctx, vars).parse();
	}

	public static <T> T eval(final char[] expression, final int start, final int offset,
			final Object ctx, final VariableResolverFactory vars, final Class<T> toType) {
		return convert(new MVELInterpretedRuntime(expression, start, offset, ctx, vars).parse(),
				toType);
	}
	 ...
	 */
	public static Object eval(final char[] expression, final Object ctx, final Map vars) {
		return new MVELInterpretedRuntime(expression, ctx, vars).parse();
	}
	 ...
	 */
	public static <T> T eval(final char[] expression, final Object ctx,
			final Map<String, Object> vars, final Class<T> toType) {
		return convert(new MVELInterpretedRuntime(expression, ctx, vars).parse(), toType);
	}
	 ...
	 */
	public static <T> T eval(final char[] expression, final Object ctx, final Class<T> toType) {
		return convert(new MVELInterpretedRuntime(expression, ctx).parse(), toType);
	}
	 ...
	 */
	public static <T> T eval(final char[] expression, final VariableResolverFactory vars,
			final Class<T> toType) {
		return convert(new MVELInterpretedRuntime(expression, null, vars).parse(), toType);
	}
	 ...
	 */
	public static <T> T eval(final char[] expression, final Map<String, Object> vars,
			final Class<T> toType) {
		return convert(new MVELInterpretedRuntime(expression, null, vars).parse(), toType);
	}
	...
	public static Object evalFile(final File file, final String encoding) throws IOException {
	...
	public static Object evalFile(final File file, final String encoding, final Object ctx)
			throws IOException {
	...
	public static Object evalFile(final File file, final String encoding, final Object ctx,
			final Map<String, Object> vars) throws IOException {
		final CachingMapVariableResolverFactory factory = new CachingMapVariableResolverFactory(vars);
		try {
	...
	private static Object _evalFile(final File file, final Object ctx,
			final VariableResolverFactory factory) throws IOException {
		return _evalFile(file, null, ctx, factory);
	}

	private static Object _evalFile(final File file, final String encoding, final Object ctx,
			final VariableResolverFactory factory) throws IOException {
	...
	public static void analysisCompile(final String expression, final ParserContext ctx) {
		analysisCompile(expression.toCharArray(), ctx);
	}

	public static Class analyze(final char[] expression, final ParserContext ctx) {
		final ExpressionCompiler compiler = new ExpressionCompiler(expression);
		compiler.setVerifyOnly(true);
		compiler.compile(ctx);
	...
	public static Class analyze(final String expression, final ParserContext ctx) {
	 ...
	 * {@link org.mvel2.integration.Interceptor Interceptors} are markers within
	 * an expression that allow external hooks to be tied into the expression.
	 * <p/>
	 * 
	 * <pre>
	 * <code>
	 ...
	 */
	public static Serializable compileExpression(final String expression,
			final Map<String, Object> imports, final Map<String, Interceptor> interceptors) {
	...
	public static Serializable compileExpression(final char[] expression, final int start,
	...
	public static Serializable compileExpression(final char[] expression, final ParserContext ctx) {
		return optimizeTree(new ExpressionCompiler(expression).compile(ctx));
	}
	...
	public static Serializable compileSetExpression(final char[] expression, final int start,
			final int offset, final ParserContext ctx) {
	...
	public static void executeSetExpression(final Serializable compiledSet, final Object ctx,
			final VariableResolverFactory vrf, final Object value) {
	...
	public static Object executeExpression(final Object compiledExpression) {
		return ((ExecutableStatement) compiledExpression).getValue(null,
	...
	public static <T> T executeExpression(final Object compiledExpression, final Object ctx,
			final Map vars, final Class<T> toType) {
	 ...
	 */
	@SuppressWarnings({ "unchecked" })
	public static <T> T executeExpression(final Object compiledExpression, final Map vars,
			final Class<T> toType) {
	...
	public static void executeExpression(final Iterable<CompiledExpression> compiledExpression) {
		for (final CompiledExpression ce : compiledExpression) {
	...
	public static void executeExpression(final Iterable<CompiledExpression> compiledExpression,
			final Object ctx, final Map vars) {
		final CachingMapVariableResolverFactory factory = new CachingMapVariableResolverFactory(vars);
	...
	public static Object[] executeAllExpression(final Serializable[] compiledExpressions,
			final Object ctx, final VariableResolverFactory vars) {
		if (compiledExpressions == null) {
			return GetterAccessor.EMPTY;
		}
		final Object[] o = new Object[compiledExpressions.length];
	...
	public static Object executeDebugger(final CompiledExpression expression, final Object ctx,
			final VariableResolverFactory vars) {
		if (expression.isImportInjectionRequired()) {
			return execute(true, expression, ctx,
					new ClassImportResolverFactory(expression.getParserConfiguration(), vars, false));
		} else {
			return execute(true, expression, ctx, vars);
		}
	}

	public static String parseMacros(final String input, final Map<String, Macro> macros) {
		return new MacroProcessor(macros).parse(input);
	}

	public static String preprocess(final char[] input, final PreProcessor[] preprocessors) {
		char[] ex = input;
		for (final PreProcessor proc : preprocessors) {
			ex = proc.parse(ex);
		}
		return new String(ex);
	}

	public static String preprocess(final String input, final PreProcessor[] preprocessors) {
		return preprocess(input.toCharArray(), preprocessors);
	}

	public static Object getProperty(final String property, final Object ctx) {
		return PropertyAccessor.get(property, ctx);
	}

	public static void setProperty(final Object ctx, final String property, final Object value) {
	...
	public static Method getStaticMethod(final Class cls, final String methodName,
		...
		try {
			final Method m = cls.getMethod(methodName, signature);
